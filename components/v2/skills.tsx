          ...
          return (
            ...
            >
              ...
              <div className="mb-4 flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-xl border border-white/10 bg-white/5 text-blue-400 transition-colors group-hover:border-blue-500/30">
