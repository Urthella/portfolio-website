...
// Fluid-simulation cursor (reactbits "SplashCursor"). Hue is constrained to a
// warm range (reds → oranges → pinks) to match the site palette, and it renders
// behind the content as a subtle interactive background.
